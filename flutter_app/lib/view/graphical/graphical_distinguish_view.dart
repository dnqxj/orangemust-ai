 ...
 * 图形识别
 */
class GraphicalDistinguishView extends StatefulWidget {
  const GraphicalDistinguishView({Key key}) : super(key: key);

  @override
  State<GraphicalDistinguishView> createState() =>
      _GraphicalDistinguishViewState();
}

class _GraphicalDistinguishViewState extends State<GraphicalDistinguishView> {
  // 声明表单控制器
  // 类型列表
  List _distinguishTypeOptions = [
    {"label": "通用物体识别", "value": "1"},
    {"label": "菜品识别", "value": "2"},
    {"label": "车型识别", "value": "3"},
    {"label": "动物识别", "value": "4"},
    {"label": "植物识别", "value": "5"},
  ...
  @override
  void initState() {
    _distinguishType = {"label": "通用物体识别", "value": "1"};
    super.initState();
  }
